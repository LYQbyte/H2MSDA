...
from files.ball import Poincare as Frechet_Poincare
from files.frechet import frechet_mean
from files.riemannian_batch_norm import RiemannianBatchNorm
# from diff_frech_mean.frechet_agg import frechet_mean


class Norm(nn.Module):

    def __init__(self, norm_type, args=None,hidden_dim=64, print_info=None, c=1.0):
